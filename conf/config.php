...
/* === LOGGING PROPERTIES === */
define('LOG_FILE',         '/var/log/proxy.log'); // The path to the log file.
define('LINE_BREAK',       "\n"); // Which line break character should be used.
define('DATE_FORMAT',      'd-m-Y H:i:s'); // The date format for the log entry
define('LOG_LEVEL',        1); // 0 = Debug (Lowest), 4 = Fatal (Highest)
define('LOG_MAX_SIZE',     0); // Maximum log file size in KB. Set to 0 for unlimited.
define('MAX_LOG_BACKUPS',  500000); // The number of log files to keep.
